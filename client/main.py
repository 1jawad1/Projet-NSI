...
class App(tk.Tk):
    def __init__(self, width, height):
        ...
        style.apply_theme(self.style, 'dark')
        ...
        self.frames = {
            ...
            "pixocial" : pixocial.Pixocial('./client/data', self.navigation_bar, self)
        }
    ...
    def draw_menu(self):
        ...
        themes_menu.add_command(label='colorful', command= lambda :self.change_theme('colorful'))
